...
// Carregue suas imagens aqui, por exemplo:
loadImage('frogger', '/assets/froggergameassets/frogger.png');
loadImage('log', '/assets/froggergameassets/log.png');
loadImage('turtle', '/assets/froggergameassets/turtle.png');
loadImage('truck', '/assets/froggergameassets/car.png');
loadImage('car', '/assets/froggergameassets/car.png');
loadImage('bulldozer', '/assets/froggergameassets/car.png');
...
Sprite.prototype.render = function() {
  ...
  context.drawImage(images[this.image], this.x, this.y, this.size, grid);
}
...
const patterns = [
  ...
  // log
  {
    ...
    image: 'log',      // image to use for the obstacle
    size: grid * 4,    // width/height of the obstacle image
