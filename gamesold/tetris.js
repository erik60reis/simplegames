(() => {
    ...
    document.getElementById("gameCanvas").width = "150";
    document.getElementById("gameCanvas").height = "300";
    document.getElementById("gameCanvas").style.width = "225px";
    document.getElementById("gameCanvas").style.height = "550px";
    ...
    */
    ...
    Tetris.Control = {
        setup : function(){
            ...
            Tetris.Tetris_currnet_canvas = $('#gameCanvas')[0].getContext("2d");
            //Tetris.Tetris_next_canvas = $('#Sub-scrren')[0].getContext("2d");
            Tetris.Tetris_currnet_size = get_size('gameCanvas');
    ...
    */
    ...
    Tetris.Score = {
        setup : function(){
            ...
            document.getElementById("score").textContent = `Score: ${this.score} High Score: ${highScore}`;
            this.lock = false;
        },
        add : function(){
            this.score += 10;
